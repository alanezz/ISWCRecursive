...
import com.hp.hpl.jena.sparql.lang.RecursiveNode;
...
public class QueryExecutionFactory
{
    ...
    static public QueryExecution create(Query query, Dataset dataset)
    {
    	...
    	if(query.isRecursive)
    	{
    		...
    		{
    			//SELECT THE STRATEGY FOR EVALUATING THE QUERY
    			//OPT FOR MEMORY
    			//OPT MAT FOR MATERIALIZED QUERIES (TDB)
    			//OPT STOP FOR MAX NUMBER OF ITERATIONS
    			
    			RecursiveNode.execQueryWithoutUnionOpt(dataset, (query.ConstructRecursiveQueries).get(i), (query.ConstructRecursiveQueries).get(i).recursiveURI);
    			//RecursiveNode.execQueryWithoutUnionOptMat(dataset, (query.ConstructRecursiveQueries).get(i), (query.ConstructRecursiveQueries).get(i).recursiveURI);
    			//RecursiveNode.execQueryWithoutUnionOptMatLim(dataset, (query.ConstructRecursiveQueries).get(i), (query.ConstructRecursiveQueries).get(i).recursiveURI,7);
    			//RecursiveNode.execQueryWithoutUnionOptStop(dataset, (query.ConstructRecursiveQueries).get(i), (query.ConstructRecursiveQueries).get(i).recursiveURI,11);
    	...
    	QueryExecution retQE = make(query, dataset) ;
