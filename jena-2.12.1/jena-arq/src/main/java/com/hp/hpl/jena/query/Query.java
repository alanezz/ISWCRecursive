...
public class Query extends Prologue implements Cloneable, Printable
{
    ...
    //public static final int QueryRecursive      = 555 ;
    ...
    //Esto es para recordar los pecados que pensaba cometer
    /*public Query innerRecursiveQuery = null;
    public String recursiveTableName = "";*/
   ...
   // public void setQueryRecursiveType()         { queryType = QueryRecursive ; }
    
    //Agregar Recursive Type??
